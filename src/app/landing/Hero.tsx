...
import { LeafIcon, ShoppingCartIcon } from "lucide-react";
  ...
  return (
    <>
      <LandingPrimaryVideoCtaSection
        ...
        description="Turn any recipe into a local grocery list in seconds"
        autoPlay
        controls={false}
        textPosition="center"
        videoPosition="center"
        videoSrc="/GroceryOut.mp4"
        // withBackground
        variant="secondary"
        leadingComponent={
          <div className="flex items-center">
            {/* <LogoIcon className="h-24 w-auto" /> */}
            {/* <ShoppingCartIcon className="h-24 w-auto text-green-600" /> */}
            <LeafIcon className="h-24 w-auto text-green-600" />
          </div>
        }
      >
        <div className="w-full mt-6 flex flex-col justify-center gap-4">
          <Button size="xl" className="p-7 text-xl" variant="primary" asChild>
            <a href="#">Try GroceryOut for free</a>
          </Button>
